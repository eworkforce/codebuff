...
const definition: AgentDefinition = {
  ...
  systemPrompt: [
    ...
    '5. **Appropriate Model**: Choose the right model for the task complexity. Default is anthropic/claude-sonnet-4 for medium-high complexity tasks, google/gemini-2.5-flash for low complexity tasks, openai/gpt-5 for reasoning tasks, especially for very complex tasks that need more time to come up with the best solution.',
